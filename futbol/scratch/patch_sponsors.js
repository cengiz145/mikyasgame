...
const sponsorPath = path.join(__dirname, '..', 'js', 'sponsor.js');

const newSponsorContent = `
// js/sponsor.js
...
fs.writeFileSync(sponsorPath, newSponsorContent, 'utf8');
console.log("sponsor.js overwritten successfully.");
