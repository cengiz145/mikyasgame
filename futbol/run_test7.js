...
// Force globals
gameCode = gameCode.replace('const gameLoop =', 'global.gameLoop =');
gameCode = gameCode.replace('function initGame()', 'global.initGame = function initGame()');
...
try {
    ...
    global.homePlayers = [];
    global.awayPlayers = [];
    if(global.initGame) global.initGame();
} catch (e) {
    // ignore init error
}
...
try {
    ...
    if(global.gameLoop) {
        ...
        console.log('gameLoop not found');
    }
} catch (e) {
